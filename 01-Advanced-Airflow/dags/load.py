...
with DAG(
    ...
    upload_local_file_to_gcs_task = LocalFilesystemToGCSOperator(
        ...
        bucket="de_airflow_taxi_silver_2",
    )
    ...
    create_dataset_task = BigQueryCreateEmptyDatasetOperator(
        ...
        # YOUR CODE HERE
        gcp_conn_id="google_cloud_connection",
        dataset_id="de_airflow_taxi_gold_2",
    )
    ...
    remove_existing_data_task = BigQueryInsertJobOperator(
        ...
        configuration={
            "query": {
                "query": f"DELETE FROM de_airflow_taxi_gold_2.trips WHERE date = '{date}'",
                "useLegacySql": False,
            }
        },
    )
    ...
    load_to_bigquery_task = GCSToBigQueryOperator(
        ...
        gcp_conn_id="google_cloud_connection",
        destination_project_dataset_table="de_airflow_taxi_gold_2.trips",
        skip_leading_rows=1,
